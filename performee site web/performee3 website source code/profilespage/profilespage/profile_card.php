...
<div class="user_card">
        <div >
            <a href="profile.php">        
    <?php echo " <img src='data:image/jpeg;base64," . base64_encode($row["profile_picture"]) . "' class='profile_card'><br>"; ?>
</a>
        </div>
      ...
      if($num_ratings==0){ echo "No ratings yet!";}
        ...
        <br></p>
         ...
         <ul class="card_ul" >
          ...
          <li><a href="index.php">Log out<img class="icon" src="../images/logout-icon.png"></a></li>
          </ul>
    
        <div calss="card_buttom"> 
       <!-- <a>Privacy ·</a> <a> Terms ·</a>  <a>Cookies ·</a> -->
        <p class="copy_rights"> Performee © 2023</p></div>
    </div>
